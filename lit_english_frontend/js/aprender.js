...
function renderCategories(data) {
  ...
  activeIllustration.innerHTML = `<img src="img/category-saudacoes-v3.png" width="385" height="385" alt="Duas pessoas se cumprimentando em inglês" class="category-illustration-img" />`;
